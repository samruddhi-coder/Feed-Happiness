...
<head>
<meta charset="utf-8">
<title>feedhappiness- Charity HTML Template | Causes Grid</title>
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                <li class="current dropdown"><a href="donar_home.jsp">Dashboard</a>
...
String sql = "Select donation.id,volunter_registration.ngo_name,volunter_registration.contact_no,volunter_registration.city,donation.description,donation.catagory1,donation.catagory2,donation.catagory3,donation.catagory4,donation.food_exp,donation.creation_date from volunter_registration INNER JOIN donation ON volunter_registration.id= donation.volunter_id where donation.cust_id="+session.getAttribute("id");
                ...
                <div class="cause-block col-md-4 col-sm-6 col-xs-12">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h2><a href="#"><%=rs.getString("ngo_name") %></a></h2>
                        ...
                        <div><a href="/NGO_Management/DeleteServlet?id=<%=rs.getInt("id")%>" class="theme-btn btn-style-one">Delete</a></div>
                    </div>
                </div>
