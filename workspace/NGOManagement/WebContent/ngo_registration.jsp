...
<head>
<meta charset="utf-8">
<title>Varna - Charity HTML Template | Causes</title>
...
function validateForm() {
  ...
  var c = document.forms["contact-form"]["reg_no"].value;
  var d = document.forms["contact-form"]["password"].value;
    ...
    <section class="who-we-are">
        <div class="outer-container clearfix">
            ...
            <div class="content-column">
                    <div class="inner-box">
                            <div class="sec-title">
                                    <h2><span>NGO</span> Registration<br> </h2>
                                    <span class="separator-two"></span>
                                </div>
                            <div class="contact-form">
                                   
                                  
                                    <form method="post" action="/NGO_Management/NGORegistrationServlet" onsubmit="return validateForm();" id="contact-form">
                                        <div class="row clearfix">
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <input type="text" name="name" onkeypress="return isCharKey(event,this)" placeholder="Organization Name" required>
                                            </div>
...
%>
                                        ...
                                        <label for="other">Other</label>&nbsp;&nbsp;
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group text-center">
                                                <button class="theme-btn btn-style-one" type="submit" onclick="return check();" name="submit-form">Register Now</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
